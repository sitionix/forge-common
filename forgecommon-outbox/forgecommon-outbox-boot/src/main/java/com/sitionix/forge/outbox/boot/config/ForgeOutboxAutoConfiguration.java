...
public class ForgeOutboxAutoConfiguration {
    ...
    @Bean
    @ConditionalOnBean(ForgeOutboxEventPublisher.class)
    ...
    @Bean
    @ConditionalOnBean({OutboxStorage.class, OutboxPublisher.class})
    @ConditionalOnMissingBean
    ...
    @Bean
    @ConditionalOnBean({OutboxStorage.class, OutboxPublisher.class, OutboxWorkerPolicy.class})
    @ConditionalOnMissingBean
    ...
    public OutboxStartupValidator outboxStartupValidator(final ForgeOutboxProperties properties,
        ...
        return new OutboxStartupValidator(properties, outboxStorageProvider);
    }
}
